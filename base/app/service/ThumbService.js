...
module.exports = class HandleServer extends Service {
    ...
    async count (data) {
        ...
        return await ctx.model.ThumbModel.count(filter);
    }
    ...
    async findOne (data) {
        const { ctx, app } = this;
        let { user, photo } = data;
        return await ctx.model.ThumbModel.findOne({
    ...
    async del ({ user, photo }) {
        ...
        await ctx.model.ThumbModel.remove(filter);
    }
    ...
    async list (data) {
        ...
        const total = await ctx.model.ThumbModel.count(filter);
        const list = await ctx.model.ThumbModel
            .find(filter)
            .sort('-created_at')
