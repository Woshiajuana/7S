...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin, AutomaticKeepAliveClientMixin<HomePage> {
  ...
  String get hoursString {
    Duration duration = _animationController.duration *
...
//    _getSizes('_keyDropDownItem', _keyDropDownItem);
  ...
  void initState() {
    ...
    kingKongItems = KingKongList
        .fromJson(menueDataJson['items'])
        .items;
    ...
    _animationController.reverse(
        from: _animationController.value == 0.0 ? 1.0 : _animationController
            .value);
